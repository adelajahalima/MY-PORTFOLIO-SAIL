...
const Projects = () => {
  const projects = [
    ...
    { title: "Sign Up Form", image: project3, livePreview: "https://adelajahalima.github.io/sign-up-form/", code: "https://github.com/adelajahalima/sign-up-form" },
    { title: "Keeper App", image: project4, livePreview: "", code: "" },
    { title: "Lorem Ipsum", image: project5, livePreview: "", code: ""  },
    { title: "Lorem Ipsum", image: project6, livePreview: "", code: ""  },
  ];
            ...
            <div key={index} className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
                  <a href={project.livePreview} className="text-gray-600 dark:text-gray-400 underline hover:no-underline hover:text-blue-950 flex items-center justify-center sm:justify-start cursor-pointer">
                  ...
                  <a href={project.code} className="text-gray-600 dark:text-gray-400 underline hover:no-underline hover:text-blue-950 flex items-center justify-center sm:justify-start cursor-pointer">
